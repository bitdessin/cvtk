...
def train(
	...
	model = cvtk.ml.torchdetapi.DetRunner(
		datalabel,
		model=model_name,
...
def inference(
	...
	for im in pred_outputs:
		...
		if output is not None:
			im.draw(layers=['bbox'], output=os.path.join(output, os.path.basename(im.source)))
...
if __name__ == '__main__':
	...
	parser_train.add_argument('--model_name', type=str, default='fasterrcnn_resnet50_fpn')
	...
	parser_inference.add_argument('--model_name', type=str, default='fasterrcnn_resnet50_fpn')
